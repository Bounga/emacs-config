...
#+BEGIN_SRC emacs-lisp
  (use-package company-emoji
    ...
    :hook (text-mode . bounga/enable-emojis))
#+END_SRC
  ...
  (use-package org-capture
    ...
    (setq org-capture-templates
          (quote (("t" "Task" entry (file+headline (lambda () (concat org-directory "/notes.org")) "Tasks")
                  ...
                  ("c" "Capture" entry (file+headline (lambda () (concat org-directory "/notes.org")) "Links")
                   "* [[%:link][%:description]]\n:PROPERTIES:\n:CREATED: %U\n:END:\n\n %i" :prepend t :immediate-finish t)
                  ("j" "Journal" entry (file+olp+datetree (lambda () (concat org-directory "/journal.org")))
                   "* %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n\n" :clock-in t :clock-resume t)
                  ("a" "Appointment" entry (file+headline (lambda () (concat org-directory "/notes.org")) "Appointments")
                   "* %?\n\n%^T\n\n")))))
